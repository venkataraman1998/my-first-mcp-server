...
This design ensures secure, auditable, and controlled access to employee data while enabling conversational querying capabilities and the client gives answers and this is how mcp works.